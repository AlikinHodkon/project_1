  ...
  return (
    <div className='w-full md:w-7/12 ml-5 mt-20 lg:ml-[5vw]'>
        <div className='xl:mt-[20vh] md:mt-[10vh] md:w-11/12'>
            <h1 className='font-Mont font-bold text-[24px] sm:text-[60px] text-black md:text-[60px]'>Hey, I&apos;m Nick</h1>
            <h3 className='font-Mont text-[14px] mt-2 lg:mt-3 sm:text-[20px] text-greydark sm:md:text-[20px]'>Frontend developer</h3>
        </div>  
        <div className='mt-10 w-11/12'>
            <div className='border-[2px] border-lavanda w-[25px] mt-2 mb-4 lg:mb-[4vh]'></div>  
            <p className='font-Mont text-[14px] text-greydark sm:text-[20px] md:text-[20px]'>Help you to create high-quality digital products that your clients will love and let your business thrive </p>
        </div>
