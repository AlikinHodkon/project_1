...
export default function MainPage() {
  return (
    <div id='main' className='section'>
        ...
        <img className="hidden sm:block sm:w-full sm:mt-[-150px] md:block md:w-8/12 md:h-1/4 md:mt-[-30vh] md:ml-auto lg:w-9/12 lg:h-1/2 xl:hidden" src="./images/photoTable.png" alt=''/>
        <img className="mt-[-100px] sm:hidden md:hidden w-full lg:hidden" src="./images/photoMob.png" alt=''/>
    </div>
  )
}
